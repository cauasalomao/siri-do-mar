/* ============================================================
   POUSADA SIRI DO MAR — main.js
   ============================================================ */

const WEBHOOK_URL = 'https://webhook.cidigitalmarketing.com/webhook/4f596ba5-158b-4c54-9958-0cf8353907ec';
const HOTEL_NAME  = 'Pousada Siri do Mar';
const WA_NUMBER   = '5541995405057';
const WA_MESSAGE  = 'Olá, vim pelo site e gostaria de mais informações!';
const BOOKING_URL = 'https://booking.hqbeds.com.br/pousadasiridomar';
const MOTOR_BASE  = 'https://booking.hqbeds.com.br/pousadasiridomar'; // motor HQBeds
...
// ── MODAL DE RESERVA (HQBeds) ──
// Formato: {MOTOR_BASE}?checkin=YYYY-MM-DD&checkout=YYYY-MM-DD&adults=N&children=N&childrenAges=A1,A2
function buildBookingURL(checkin, checkout, adults, childAges) {
  ...
  const params = new URLSearchParams({
    ...
    children: String((childAges && childAges.length) || 0)
  });
  if (childAges && childAges.length) params.set('childrenAges', childAges.join(','));
  ...
  const html = `
    <div class="bk-modal" id="bkModal" role="dialog" aria-modal="true" aria-labelledby="bkTitle" aria-hidden="true">
      <div class="bk-modal-box">
        ...
        <div class="bk-header">
          <img src="/assets/img/logo-siri-do-mar.jpg" alt="${HOTEL_NAME}" width="48" height="48" style="border-radius:50%;object-fit:cover">
          <div>
